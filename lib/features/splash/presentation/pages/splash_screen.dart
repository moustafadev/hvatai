...
class _CameraExampleHomeState extends State<CameraExampleHome>
  ...
  void initState() {
    ...
    _initializeCameraAndStartStreaming();
  }

  Future<void> _initializeCameraAndStartStreaming() async {
    try {
      ...
      final cameraDescription = cameras.length > 1 ? cameras[1] : cameras[0];
      ...
      if (isControllerInitialized && !isStreaming) {
  ...
  Widget _cameraPreviewWidget() {
    ...
    print('isControllerInitialized: $isControllerInitialized');
    if (controller == null || !isControllerInitialized) {
      return const Text(
        'Tap a camera',
        style: TextStyle(
  ...
  Future<String?> startVideoStreaming() async {
    ...
    // Use the URL directly without showing dialog
