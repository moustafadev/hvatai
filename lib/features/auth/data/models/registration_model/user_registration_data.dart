...
class UserRegistrationData with _$UserRegistrationData {
  const factory UserRegistrationData({
    ...
    @JsonKey(name: 'password_confirmation', includeIfNull: false) String? passwordConfirmation,
    @JsonKey(name: 'terms_agreement', includeIfNull: false) bool? agreedToTerms,
    ...
    @JsonKey(name: 'image_business', includeIfNull: false) String? imageBusiness,
    ...
    @JsonKey(name: 'email_verified_at', includeIfNull: false) String? emailVerifiedAt,
    @JsonKey(includeIfNull: false) String? address,
    @JsonKey(name: 'personal_rating', includeIfNull: false) int? personalRating,
    @JsonKey(name: 'personal_rating_count', includeIfNull: false) int? personalRatingCount,
    @JsonKey(name: 'business_rating', includeIfNull: false) int? businessRating,
    @JsonKey(name: 'business_rating_count', includeIfNull: false) int? businessRatingCount,
