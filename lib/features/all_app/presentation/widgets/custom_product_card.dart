...
class CustomProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final blocChild = BlocConsumer<ProductDetailsCubit, ProductDetailsState>(
              ...
              children: [
                Stack(
                  children: [
                    ...
                    if (showSaleTypeChip || variant.discountType != null)
                      Positioned(
                        top: 8.h,
                        left: 8.w,
                        child: Column(
                          ...
                          children: [
                            ...
                            if (variant.discountType != null &&
                                isNameCompany == false && showFixed)
                              Padding(
                                padding: EdgeInsets.only(
                                    top: showSaleTypeChip ? 4.h : 0),
                                child: Container(
                                  padding: EdgeInsets.symmetric(
                                      horizontal: 8.w, vertical: 4.h),
                                  decoration: BoxDecoration(
